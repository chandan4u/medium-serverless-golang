  ...
  return new Promise((resolve, reject) => {
    ...
    serverlessSDK
      ...
      .then(() => {
        ...
        try {
          const userHandler = require('./${fn.entryOrig}.js');   
          const result = userHandler.${fn.handlerOrig}(event, contextProxy, finalize);        
...
serverlessSDK = new serverlessSDK({
  ...
  shouldLogMeta: ${!ctx.sls.service.custom || !ctx.sls.service.custom.enterprise || ctx.sls.service.custom.enterprise.collectLambdaLogs !== false},
...
sdk = serverless_sdk.SDK(
    ...
    should_log_meta=${!ctx.sls.service.custom || !ctx.sls.service.custom.enterprise || ctx.sls.service.custom.enterprise.collectLambdaLogs !== false ? 'True' : 'False'},
